...
%% Version 5 - Fixed text overlapping
%% ===========================================
...
\node[font=\small\bfseries, c_nonlatin!90!black, above=10pt] 
    at (axis cs:India, 105) {Perception Bottleneck};

% Reasoning Bottleneck - moved to the right side of EU bar to avoid Taiwan overlap
\draw[-{Stealth[length=5pt, width=4pt]}, line width=1pt, c_reason]
    ([xshift=18pt]axis cs:EU, 85) -- ([xshift=18pt]axis cs:EU, 55);
\node[font=\small\bfseries, c_reason, anchor=west] 
    at ([xshift=20pt]axis cs:EU, 95) {Reasoning};
\node[font=\small\bfseries, c_reason, anchor=west] 
    at ([xshift=20pt]axis cs:EU, 87) {Bottleneck};
