...
%% Version 7 - Fixed percentage labels visibility
%% ===========================================
...
% ===== Key percentage labels (LARGER, with solid background) =====

% Japan: Non-Latin 43% (centered in orange segment)
\node[font=\small\bfseries, text=black, 
      fill=white, inner sep=3pt, rounded corners=2pt,
      draw=c_nonlatin!50!black, line width=0.4pt] 
    at (axis cs:Japan, 21.5) {43\%};

% India: Non-Latin 56% (centered in orange segment)
\node[font=\small\bfseries, text=black,
      fill=white, inner sep=3pt, rounded corners=2pt,
      draw=c_nonlatin!50!black, line width=0.4pt] 
    at (axis cs:India, 28) {56\%};

% India: OCR 41% (centered in sky blue segment)
\node[font=\small\bfseries, text=black,
      fill=white, inner sep=3pt, rounded corners=2pt,
      draw=c_ocr!50!black, line width=0.4pt] 
    at (axis cs:India, 77) {41\%};

% S.Korea: Non-Latin 51% (centered in orange segment)
\node[font=\small\bfseries, text=black,
      fill=white, inner sep=3pt, rounded corners=2pt,
      draw=c_nonlatin!50!black, line width=0.4pt] 
    at (axis cs:S.Korea, 25.5) {51\%};

% EU: Reasoning 48% (centered in blue segment)
